...
!GCC$ ATTRIBUTES DLLIMPORT :: MPI_BOTTOM, MPI_IN_PLACE
  ...
  integer,          private, parameter :: NContBox8       = 700
! integer,          private, parameter :: NAtomBox8       = 12
! integer,          private, parameter :: NBondBox8       = 20
! integer,          private, parameter :: NAnglBox8       = 30
! integer,          private, parameter :: NDiheBox8       = 70
! integer,          private, parameter :: NImprBox8       = 5
! integer,          private, parameter :: NCmapBox8       = 10
! integer,          private, parameter :: NHGrpBox8       = 40
! integer,          private, parameter :: NHMovBox8       = 8
! integer,          private, parameter :: NContBox8       = 30 
  integer,          private, parameter :: NVsite2Box8     = 100
  integer,          private, parameter :: NVsite3Box8     = 100
  integer,          private, parameter :: NVsite3fdBox8   = 100
  integer,          private, parameter :: NVsite3fadBox8  = 100
  integer,          private, parameter :: NVsite3outBox8  = 100
  integer,          private, parameter :: NVsite4fdnBox8  = 100
  integer,          private, parameter :: NVsitenBox8     = 100
#ifdef USE_GPU
...
contains
  ...
  subroutine setup_domain(ene_info, con_info, &
    ...
    !
    call setup_cell_capacity(ene_info, boundary, domain, molecule)
  ...
  subroutine setup_cell_capacity(ene_info, boundary, domain, molecule)
    ...
    if (ene_info%forcefield == ForcefieldCAGO) v = v / 20.0_dp
    ...
    MaxVsite2     = int(v_rate * real(NVsite2Box8,dp)    * ShrinkRate)
    MaxVsite3     = int(v_rate * real(NVsite3Box8,dp)    * ShrinkRate)
    MaxVsite3fd   = int(v_rate * real(NVsite3fdBox8,dp)  * ShrinkRate)
    MaxVsite3fad  = int(v_rate * real(NVsite3fadBox8,dp) * ShrinkRate)
    MaxVsite3out  = int(v_rate * real(NVsite3outBox8,dp) * ShrinkRate)
    MaxVsite4fdn  = int(v_rate * real(NVsite4fdnBox8,dp) * ShrinkRate)
    MaxVsiten     = int(v_rate * real(NVsitenBox8,dp)    * ShrinkRate)
    ...
    ImprMove      = MaxImpr  / 2
    CmapMove      = MaxCmap  / 2
    Vsite2Move    = MaxVsite2 / 2
    Vsite3Move    = MaxVsite3  / 2
    Vsite3fdMove  = MaxVsite3fd  / 2
    Vsite3fadMove = MaxVsite3fad / 2
    Vsite3outMove = MaxVsite3out / 2
    Vsite4fdnMove = MaxVsite4fdn / 2
    VsitenMove    = MaxVsiten / 2
    ...
    if (main_rank) then
      ...
      write(MsgOut,*) 'sp_enefunc_str    ::MaxVsite2    : ', MaxVsite2
      write(MsgOut,*) 'sp_enefunc_str    ::MaxVsite3    : ', MaxVsite3
      write(MsgOut,*) 'sp_enefunc_str    ::MaxVsite3fd  : ', MaxVsite3fd
      write(MsgOut,*) 'sp_enefunc_str    ::MaxVsite3fad : ', MaxVsite3fad
      write(MsgOut,*) 'sp_enefunc_str    ::MaxVsite3out : ', MaxVsite3out
      write(MsgOut,*) 'sp_enefunc_str    ::MaxVsite4fdn : ', MaxVsite4fdn
      write(MsgOut,*) 'sp_enefunc_str    ::MaxVsiten    : ', MaxVsiten
      ...
      write(MsgOut,*) 'sp_enefunc_str    ::Vsite2Move   : ', Vsite2Move
      write(MsgOut,*) 'sp_enefunc_str    ::Vsite3Move   : ', Vsite3Move
      write(MsgOut,*) 'sp_enefunc_str    ::Vsite3fdMove : ', Vsite3fdMove
      write(MsgOut,*) 'sp_enefunc_str    ::Vsite3fadMove: ', Vsite3fadMove
      write(MsgOut,*) 'sp_enefunc_str    ::Vsite3outMove: ', Vsite3outMove
      write(MsgOut,*) 'sp_enefunc_str    ::Vsite4fdnMove: ', Vsite4fdnMove
      write(MsgOut,*) 'sp_enefunc_str    ::VsitenMove   : ', VsitenMove
      write(MsgOut,*) ''
      write(MsgOut,*) 'sp_enefunc_str    ::MaxNb15      : ', MaxNb15
      write(MsgOut,*) 'sp_enefunc_str    ::MaxNb15Water : ', MaxNb15Water
      write(MsgOut,*) ''
