...
contains
  ...
  subroutine compute_energy_flexible_angle(enefunc, coord, force, virial, eangle)
...
!    real(wp),        pointer :: fc(:), theta0(:)
  ...
  subroutine compute_energy_angle_pbc(enefunc, boundary, coord, force, virial, eangle)
  ...
  subroutine compute_energy_flexible_angle_pbc(enefunc, boundary, coord, force, virial, eangle)
  ...
  subroutine compute_energy_local_angle_pbc(enefunc, boundary, coord, force, virial, eangle)
