...
contains
  ...
  subroutine compute_energy_nonbond_table_solute_linear_check(enefunc, molecule,&
                                             boundary, pairlist, coord, force, &
                                             virial, eelec, evdw)
  ...
  subroutine compute_energy_nonbond_table_water_linear_check(enefunc, molecule,&
                                                   boundary, pairlist, coord, &
                                                   force, virial, eelec, evdw)
