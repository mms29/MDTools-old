...
contains
  ...
  subroutine compute_energy_bond_pbc(enefunc, boundary, coord, force, virial, ebond)
  ...
  subroutine compute_energy_bond_quartic_pbc(enefunc, boundary, coord, force, virial, ebond)
