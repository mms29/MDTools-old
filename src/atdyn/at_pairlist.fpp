...
contains
  ...
  subroutine update_pairlist_nobc_cg(enefunc, coord, pairlist)
    ...
    ! check memory size
    !
    call check_pairlist_memory_size(num_DNA_bp, pairlist%num_cg_DNA_basepair_max, &
        need_reallocate_1)
  ...
  !> @brief        update pairlist for CG protein-DNA seq-(non)specific interaction
  !! @authors      CT
  !! @param[in]    enefunc  : information of potential energy function
  !! @param[in]    coord    : atomic coordinate
  !! @param[inout] pairlist : information of pairlist
...
! end subroutine update_pairlist_pbc_cell
  ...
  !
  !======1=========2=========3=========4=========5=========6=========7=========8
  subroutine update_pairlist_pbc_cg_general(enefunc, boundary, coord_pbc, pairlist)
        ...
        if (mod(i_atom - 1, nproc_city * nthread) == my_id) then
          ...
          do i_nbcell = 1, boundary%num_neighbor_cells_CG_exv
            ...
            do while (j_atom > i_atom)
              ...
              ! 
              if (enefunc%cg_kh_mol_pair(i_chain_id, j_chain_id) > 0 .and. &
                  enefunc%cg_pro_use_KH(i_atom) .and. enefunc%cg_pro_use_KH(j_atom)) then
...
!             dij(1:3)     = dij(1:3) - dij_pbc(1:3)
              ...
              if (rij_sqr < pairdist_ele_sqr) then
                ...
                if (.not. do_allocate) then
                  ...
                  if ( ( is_phos_i .and. is_pro_j ) .or. ( is_phos_j .and. is_pro_i ) ) then
                    pairlist%cg_ele_scaling_list(num_ele(id), id) = &
                        - enefunc%cg_pro_DNA_ele_scale_Q / 0.6
                  else
                    pairlist%cg_ele_scaling_list(num_ele(id), id) = 1.0_wp
  ...
  !
  !======1=========2=========3=========4=========5=========6=========7=========8
  subroutine update_pairlist_pbc_cg_DNA_base(enefunc, boundary, coord_pbc, pairlist)
    ...
    !
    call check_pairlist_memory_size(num_DNA_bp, pairlist%num_cg_DNA_basepair_max, &
        pairlist%allocate_pbc_cg_DNA_bp)
  ...
  !
  !======1=========2=========3=========4=========5=========6=========7=========8
  subroutine update_pairlist_pbc_cg_DNA_exv(enefunc, boundary, coord_pbc, pairlist)
  ...
  !
  !======1=========2=========3=========4=========5=========6=========7=========8
  subroutine update_pairlist_pbc_cg_IDR_HPS(enefunc, boundary, coord_pbc, pairlist)
  ...
  !
  !======1=========2=========3=========4=========5=========6=========7=========8
  subroutine update_pairlist_pbc_cg_IDR_KH(enefunc, boundary, coord_pbc, pairlist)
  ...
  !
  !======1=========2=========3=========4=========5=========6=========7=========8
  subroutine update_pairlist_pbc_cg_pwmcos(enefunc, boundary, coord_pbc, pairlist)
    ...
    ! check memory size
    !
    call check_pairlist_memory_size(num_pairlist_pwmcos, pairlist%num_cg_pwmcos_max, &
        pairlist%allocate_pbc_cg_pwmcos)
  ...
  !
  !======1=========2=========3=========4=========5=========6=========7=========8
  subroutine update_pairlist_pbc_cg_pwmcosns(enefunc, boundary, coord_pbc, pairlist)
    ...
    ! check memory size
    !
    call check_pairlist_memory_size(num_pairlist_pwmcosns, pairlist%num_cg_pwmcosns_max, &
        pairlist%allocate_pbc_cg_pwmcosns)
